...
function App() {
  ...
  return (
    <div className="flex flex-col h-screen w-screen  justify-center items-center">
      <div className="grid grid-cols-1 w-9/10 h-full gap-7 py-5 font-ibm min-[440px]:justify-items-center min-[620px]:w-7/10 md:text-lg lg:text-sm lg:w-full lg:grid-cols-12 lg:grid-rows-7 lg:gap-4 lg:px-3">
        {/* Small upper-bar */}
